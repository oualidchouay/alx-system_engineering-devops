...
-	You must use the `while` loop (`for` and u`ntil` are forbidden)
...
-	Download and commit the [apache-access.log](https://intranet-projects-files.s3.amazonaws.com/holbertonschool-sysadmin_devops/80/apache-access.log "apache-access.log") file along with your answers files
